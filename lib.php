...
require_once($CFG->dirroot.'/repository/nuxeoworkspaces/locallib.php');
...
//         header('Content-Length: ' . filesize($temp));
    ...
    /**
     *
     * @param array $documents result of function {@link nuxeows::getFilesFrom($path) or @link nuxeows::getRoot() }
